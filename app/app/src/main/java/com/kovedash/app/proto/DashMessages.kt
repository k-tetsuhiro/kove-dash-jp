...
object DashMessages {
     ...
     * We push distances in meters/km (cur/path_unittype 0/1, same as the OEM) and this tells the
     * dash how to label them. This build is metric-only — km / ℃ / km/h — so we always send
     * `unit:1`, which also makes the dash's own "℃" weather label match the Celsius we push.
     */
    fun setUnit(): String =
        """{"msg_id":25,"msg_type":14,"msg_source":2,"unit":1}"""
